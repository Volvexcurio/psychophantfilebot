...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://github.com/Volvexcurio/psychophantfilebot)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/Volvexcurio/psychophantfilebot
cd File-Sharing-Bot
